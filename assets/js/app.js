...
<a class="navbar-brand" href="index.html">magunghkm</a>
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      ...
      <p class="tag" >Theory and practice are completely different, so chase them until the end. Don't stop learning.</p>
    </div>    

    <div class="rounded-social-buttons tag">
    <a class="social-button linkedin" href="https://www.linkedin.com/in/muhammad-agung-hikmatullah-1725481a1/" target="_blank" >
    ...
    <a class="social-button github" href="https://github.com/MAgungHKM" target="_blank">
